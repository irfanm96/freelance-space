...
<head>
    ...
    <link  rel="stylesheet" href="{{ asset('css/tailwind.min.css') }}" type="text/css" media="all">
    ...
    <div class="antialiased sans-serif min-h-screen bg-white" style="min-height: 900px">
        <div class="container mx-auto py-6 px-4">
            <div class="flex justify-between">
                <h2 class="text-2xl font-bold mb-6 pb-2 tracking-wider uppercase">{{$invoice->user->name}} <span
                        class="text-sm lowercase">({{$invoice->user->email}})</span></h2>
                @if ($iframe)
                <div>
                    <div class="relative mr-4 inline-block">
                        <div
                            ...
                            <a target="_blank" href="{{route('invoice.pdf',$invoice->id)}}">
            ...
            <div class="flex flex-wrap justify-between mb-8">
                ...
                <div class="w-full md:w-1/3">
                    <label class="text-gray-800 block mb-1 font-bold text-sm uppercase tracking-wide">Bank
                        Detail:</label>
                    <div
                        class="space-y-3 bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight">
